...
<body>
	...
	<div class="box">
		<div class="textbox">
	  		<input type="text" id="ex_input" readonly style="font-family: 'Jeju Gothic';"   value=<%= title%> readonly >
		</div>
		<textarea placeHolder="CONTENT" style="font-family: 'Jeju Gothic';" readonly ><%=content%></textarea>
